...
# É necessário clicar na janela do gráfico para adicionar labels (de acordo com a quantidade de divisões existentes no gráfico)

#cex.main=valor - Para alterar tamanho da fonte do título

pie(alunos, main= "Grau de escolaridade",cex.main=1.5)

# cex=valor - Para alterar tamanho da fonte dos nomes das variáveis

pie(alunos, cex=0.8)

# init.angle=valor - Para girar o gráfico
